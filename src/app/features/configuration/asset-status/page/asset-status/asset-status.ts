...
@Component({
  ...
  styleUrl: './asset-status.css',
})
export class AssetStatus implements OnInit {
  ...
  createComponent() {
    import('../../components/asset-status-list/asset-status-list').then((m) =>
    {
      const ref = this.container().createComponent(m.AssetStatusList, {
